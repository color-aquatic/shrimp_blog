...
- **Scientific name**: Caridina sp. "Pure Black Line"
- **Size**: 2-2.5 cm when fully grown
- **Coloration**: Pure black and white patterns only (no red variants)
- **Temperament**: Peaceful, active in groups
- **Care difficulty**: Easy to Intermediate (hardy variety)
...
1. **Tank**: Minimum 30cm tank for optimal colony development
2. **Substrate**: ADA Amazonia Gold or Benibachi substrates recommended
3. **Filter**: Gentle biological filtration to preserve beneficial bacteria
4. **LED lighting**: Moderate intensity for plant health
5. **Aquatic plants**: Moss varieties for grazing and natural filtration
...
1.5-2 years under optimal care conditions.